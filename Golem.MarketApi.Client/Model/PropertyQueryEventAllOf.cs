...
namespace Golem.MarketApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PropertyQueryEventAllOf :  IEquatable<PropertyQueryEventAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyQueryEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PropertyQueryEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyQueryEventAllOf" /> class.
        /// </summary>
        /// <param name="propertyQuery">propertyQuery (required).</param>
        public PropertyQueryEventAllOf(PropertyQuery propertyQuery = default(PropertyQuery))
        {
            // to ensure "propertyQuery" is required (not null)
            this.PropertyQuery = propertyQuery ?? throw new ArgumentNullException("propertyQuery is a required property for PropertyQueryEventAllOf and cannot be null");;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertyQueryEventAllOf {\n");
        ...
        {
            return this.Equals(input as PropertyQueryEventAllOf);
        }

        /// <summary>
        /// Returns true if PropertyQueryEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyQueryEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyQueryEventAllOf input)
        {
            if (input == null)
                return false;
