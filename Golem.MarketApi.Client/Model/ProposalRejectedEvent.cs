...
namespace Golem.MarketApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProposalRejectedEvent : Event,  IEquatable<ProposalRejectedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProposalRejectedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProposalRejectedEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProposalRejectedEvent" /> class.
        /// </summary>
        ...
        public ProposalRejectedEvent(Reason reason = default(Reason), string eventType = default(string), DateTime eventDate = default(DateTime)) : base(eventType, eventDate)
        {
            this.Reason = reason;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProposalRejectedEvent {\n");
        ...
        {
            return this.Equals(input as ProposalRejectedEvent);
        }

        /// <summary>
        /// Returns true if ProposalRejectedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of ProposalRejectedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProposalRejectedEvent input)
        {
            if (input == null)
                return false;
