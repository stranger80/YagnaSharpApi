...
{
    /// <summary>
    /// RuntimeEventKindStdOutAllOf
    /// </summary>
    [DataContract]
    public partial class RuntimeEventKindStdOutAllOf :  IEquatable<RuntimeEventKindStdOutAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RuntimeEventKindStdOutAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RuntimeEventKindStdOutAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RuntimeEventKindStdOutAllOf" /> class.
        /// </summary>
        /// <param name="stdout">stdout (required).</param>
        public RuntimeEventKindStdOutAllOf(Object stdout = default(Object))
        {
            // to ensure "stdout" is required (not null)
            this.Stdout = stdout ?? throw new ArgumentNullException("stdout is a required property for RuntimeEventKindStdOutAllOf and cannot be null");;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RuntimeEventKindStdOutAllOf {\n");
        ...
        {
            return this.Equals(input as RuntimeEventKindStdOutAllOf);
        }

        /// <summary>
        /// Returns true if RuntimeEventKindStdOutAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RuntimeEventKindStdOutAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RuntimeEventKindStdOutAllOf input)
        {
            if (input == null)
                return false;
