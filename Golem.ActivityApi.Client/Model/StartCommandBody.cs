...
namespace Golem.ActivityApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StartCommandBody :  IEquatable<StartCommandBody>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StartCommandBody" /> class.
        /// </summary>
        /// <param name="args">args.</param>
        public StartCommandBody(List<string> args = default(List<string>))
        {
            this.Args = args;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StartCommandBody {\n");
        ...
        {
            return this.Equals(input as StartCommandBody);
        }

        /// <summary>
        /// Returns true if StartCommandBody instances are equal
        /// </summary>
        /// <param name="input">Instance of StartCommandBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StartCommandBody input)
        {
            if (input == null)
                return false;
