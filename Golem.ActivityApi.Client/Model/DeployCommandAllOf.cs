...
namespace Golem.ActivityApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeployCommandAllOf :  IEquatable<DeployCommandAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeployCommandAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeployCommandAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeployCommandAllOf" /> class.
        /// </summary>
        /// <param name="deploy">deploy (required).</param>
        public DeployCommandAllOf(Object deploy = default(Object))
        {
            // to ensure "deploy" is required (not null)
            this.Deploy = deploy ?? throw new ArgumentNullException("deploy is a required property for DeployCommandAllOf and cannot be null");;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeployCommandAllOf {\n");
        ...
        {
            return this.Equals(input as DeployCommandAllOf);
        }

        /// <summary>
        /// Returns true if DeployCommandAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DeployCommandAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeployCommandAllOf input)
        {
            if (input == null)
                return false;
