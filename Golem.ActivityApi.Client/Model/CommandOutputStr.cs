...
namespace Golem.ActivityApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommandOutputStr : CommandOutput,  IEquatable<CommandOutputStr>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandOutputStr" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommandOutputStr() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandOutputStr" /> class.
        /// </summary>
        /// <param name="str">str (required).</param>
        public CommandOutputStr(string str = default(string)) : base()
        {
            // to ensure "str" is required (not null)
            this.Str = str ?? throw new ArgumentNullException("str is a required property for CommandOutputStr and cannot be null");;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommandOutputStr {\n");
        ...
        {
            return this.Equals(input as CommandOutputStr);
        }

        /// <summary>
        /// Returns true if CommandOutputStr instances are equal
        /// </summary>
        /// <param name="input">Instance of CommandOutputStr to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommandOutputStr input)
        {
            if (input == null)
                return false;
