...
{
    /// <summary>
    /// TransferCommandAllOf
    /// </summary>
    [DataContract]
    public partial class TransferCommandAllOf :  IEquatable<TransferCommandAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferCommandAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferCommandAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferCommandAllOf" /> class.
        /// </summary>
        /// <param name="transfer">transfer (required).</param>
        public TransferCommandAllOf(TransferCommandBody transfer = default(TransferCommandBody))
        {
            // to ensure "transfer" is required (not null)
            this.Transfer = transfer ?? throw new ArgumentNullException("transfer is a required property for TransferCommandAllOf and cannot be null");;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferCommandAllOf {\n");
        ...
        {
            return this.Equals(input as TransferCommandAllOf);
        }

        /// <summary>
        /// Returns true if TransferCommandAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferCommandAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferCommandAllOf input)
        {
            if (input == null)
                return false;
