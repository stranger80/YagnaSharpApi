...
namespace Golem.ActivityApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DestroyActivity : ProviderEvent,  IEquatable<DestroyActivity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DestroyActivity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DestroyActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DestroyActivity" /> class.
        /// </summary>
        ...
        public DestroyActivity(string eventType = default(string), DateTime eventDate = default(DateTime), string activityId = default(string), string agreementId = default(string)) : base(eventType, eventDate, activityId, agreementId)
        {
        }
        ...
        {
            return this.Equals(input as DestroyActivity);
        }

        /// <summary>
        /// Returns true if DestroyActivity instances are equal
        /// </summary>
        /// <param name="input">Instance of DestroyActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestroyActivity input)
        {
            if (input == null)
                return false;
