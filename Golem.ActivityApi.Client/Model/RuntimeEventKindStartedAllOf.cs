...
{
    /// <summary>
    /// RuntimeEventKindStartedAllOf
    /// </summary>
    [DataContract]
    public partial class RuntimeEventKindStartedAllOf :  IEquatable<RuntimeEventKindStartedAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RuntimeEventKindStartedAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RuntimeEventKindStartedAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RuntimeEventKindStartedAllOf" /> class.
        /// </summary>
        ...
        public RuntimeEventKindStartedAllOf(Object started = default(Object))
        {
            // to ensure "started" is required (not null)
            this.Started = started ?? throw new ArgumentNullException("started is a required property for RuntimeEventKindStartedAllOf and cannot be null");;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RuntimeEventKindStartedAllOf {\n");
        ...
        {
            return this.Equals(input as RuntimeEventKindStartedAllOf);
        }

        /// <summary>
        /// Returns true if RuntimeEventKindStartedAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RuntimeEventKindStartedAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RuntimeEventKindStartedAllOf input)
        {
            if (input == null)
                return false;
