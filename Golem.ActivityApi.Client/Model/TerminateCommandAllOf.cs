...
{
    /// <summary>
    /// TerminateCommandAllOf
    /// </summary>
    [DataContract]
    public partial class TerminateCommandAllOf :  IEquatable<TerminateCommandAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TerminateCommandAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TerminateCommandAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TerminateCommandAllOf" /> class.
        /// </summary>
        /// <param name="terminate">terminate (required).</param>
        public TerminateCommandAllOf(Object terminate = default(Object))
        {
            // to ensure "terminate" is required (not null)
            this.Terminate = terminate ?? throw new ArgumentNullException("terminate is a required property for TerminateCommandAllOf and cannot be null");;
        }
        ...
        public Object Terminate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TerminateCommandAllOf {\n");
        ...
        {
            return this.Equals(input as TerminateCommandAllOf);
        }

        /// <summary>
        /// Returns true if TerminateCommandAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TerminateCommandAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TerminateCommandAllOf input)
        {
            if (input == null)
                return false;
