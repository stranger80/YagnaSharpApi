...
namespace Golem.PaymentApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebitNoteRejectedEvent : DebitNoteEvent,  IEquatable<DebitNoteRejectedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitNoteRejectedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DebitNoteRejectedEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitNoteRejectedEvent" /> class.
        /// </summary>
        ...
        public DebitNoteRejectedEvent(string debitNoteId = default(string), Rejection rejection = default(Rejection), string eventType = default(string), DateTime eventDate = default(DateTime)) : base(eventType, eventDate)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DebitNoteRejectedEvent {\n");
        ...
        {
            return this.Equals(input as DebitNoteRejectedEvent);
        }

        /// <summary>
        /// Returns true if DebitNoteRejectedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DebitNoteRejectedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebitNoteRejectedEvent input)
        {
            if (input == null)
                return false;
