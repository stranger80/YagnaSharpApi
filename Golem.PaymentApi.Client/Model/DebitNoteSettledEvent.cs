...
namespace Golem.PaymentApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebitNoteSettledEvent : DebitNoteEvent,  IEquatable<DebitNoteSettledEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitNoteSettledEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DebitNoteSettledEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitNoteSettledEvent" /> class.
        /// </summary>
        ...
        public DebitNoteSettledEvent(string debitNoteId = default(string), string eventType = default(string), DateTime eventDate = default(DateTime)) : base(eventType, eventDate)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DebitNoteSettledEvent {\n");
        ...
        {
            return this.Equals(input as DebitNoteSettledEvent);
        }

        /// <summary>
        /// Returns true if DebitNoteSettledEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DebitNoteSettledEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebitNoteSettledEvent input)
        {
            if (input == null)
                return false;
