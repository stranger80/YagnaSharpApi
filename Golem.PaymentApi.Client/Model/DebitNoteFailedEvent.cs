...
namespace Golem.PaymentApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebitNoteFailedEvent : DebitNoteEvent,  IEquatable<DebitNoteFailedEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitNoteFailedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DebitNoteFailedEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitNoteFailedEvent" /> class.
        /// </summary>
        ...
        public DebitNoteFailedEvent(string debitNoteId = default(string), string eventType = default(string), DateTime eventDate = default(DateTime)) : base(eventType, eventDate)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DebitNoteFailedEvent {\n");
        ...
        {
            return this.Equals(input as DebitNoteFailedEvent);
        }

        /// <summary>
        /// Returns true if DebitNoteFailedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DebitNoteFailedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebitNoteFailedEvent input)
        {
            if (input == null)
                return false;
