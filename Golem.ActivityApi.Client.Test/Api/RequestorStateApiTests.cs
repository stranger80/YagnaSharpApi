...
{
    /// <summary>
    ///  Class for testing RequestorStateApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class RequestorStateApiTests : IDisposable
    {
        private RequestorStateApi instance;

        public RequestorStateApiTests()
        {
            instance = new RequestorStateApi();
        }
        ...
        /// <summary>
        /// Test an instance of RequestorStateApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsInstanceOfType' RequestorStateApi
            //Assert.IsType(typeof(RequestorStateApi), instance, "instance is a RequestorStateApi");
        }
        ...
        /// <summary>
        /// Test GetRunningCommand
        /// </summary>
        [Fact]
        public void GetRunningCommandTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string activityId = null;
            //var response = instance.GetRunningCommand(activityId);
            //Assert.IsType<List<ExeScriptCommandState>> (response, "response is List<ExeScriptCommandState>");
        }
