...
namespace YagnaSharpApi.Engine
{
    public abstract class ServiceBase : IDisposable
    {
        ...
        /// <returns></returns>
        public abstract IAsyncEnumerable<Command> OnStartupAsync(WorkContext ctx);
        ...
        /// <param name="ctx"></param>
        /// <returns></returns>
        public abstract IAsyncEnumerable<Command> OnRunAsync(WorkContext ctx, CancellationToken cancellationToken);
        ...
        /// <param name="ctx"></param>
        /// <returns></returns>
        public abstract IAsyncEnumerable<Command> OnShutdownAsync(WorkContext ctx, Exception error = null);
        ...
        protected async Task ExecuteLifecycleStepAsync(Engine engine, AgreementEntity agreement, ActivityEntity activity, WorkContext ctx, string taskId, Func<IAsyncEnumerable<Command>> commandGenerator)
        {
